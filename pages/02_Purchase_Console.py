...
def get_full_purchase_data():
    try:
        # Filter: Hide Enquiry/Estimation
...
if not df_items.empty:
    ...
    if not pending_items.empty:
        ...
        if critical_count > 0:
            st.error(f"🚨 **Action Required:** {critical_count} items have been pending for over 48 hours.")
...
if not df_p.empty:
    for _, p_row in df_p.iterrows():
        ...
        # RE-INTEGRATED PRODUCTION SOURCE DETECTION
