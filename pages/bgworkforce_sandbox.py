        ...
        if my_plans:
            ...
            for p in my_plans:
                ...
                if p['status'] == 'Pending':
                    ...
                    if b_col.button("✅ Done", key=f"done_{p['id']}", use_container_width=True):
                    ...
                    b_col.write("Completed")
        else:
            st.caption("No plans noted for today yet.")
